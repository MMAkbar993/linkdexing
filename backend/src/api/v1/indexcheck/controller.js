...
// Exported so the developer API (src/api/v1/dev/controller.js) can create a
// batch the same way the browser routes below do, rather than duplicating
// the credit-charge-and-submit logic.
